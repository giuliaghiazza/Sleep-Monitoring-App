...
patients = [
    ('Pippo', 'Franco', 'Pippo', 'Rossi', 37, "Male", 1),
    ('LucaM', 'pass123', 'Luca', 'Marini', 23, "Male", None),
    ('AnnaS', 'anna2025', 'Anna', 'Santoro', 57, "Female", None),
    ('MarioR', 'mario456', 'Mario', 'Rossi', 43, "Male", 1),
    ('ElisaT', 'elisa789', 'Elisa', 'Tarantino', 19, "Female", None),
]

for username, psw, name, surname, age, gender, doctor in patients:
    c.execute("""
    ...
    user_id = c.lastrowid
    c.execute("""
        INSERT INTO patients (Name, Surname, user_id, Age, Gender, assigned_doctor)
        VALUES (?, ?, ?, ?, ?, ?)
    """, (name, surname, user_id, age, gender, doctor))
