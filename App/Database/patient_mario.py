...
c.execute("""
    ...
    VALUES (?, ?, ?, ?, datetime('now'), ?)
""", (8, 8, 1, 'Reports/Prescriptions/pramipexole_rx.pdf', 'medicine'))
...
c.execute("""
    INSERT INTO Prescription (appointment_id, patient, doctor, file_path, created_at, type)
    VALUES (?, ?, ?, ?, datetime('now'), ?)
""", (6, 8, 1, 'Reports/Prescriptions/eeg_ZMachine_rx.pdf', 'device'))
...
c.execute("""
    INSERT INTO Prescription (appointment_id, patient, doctor, file_path, created_at, type)
    VALUES (?, ?, ?, ?, datetime('now'), ?)
""", (6, 8, 1, 'Reports/Prescriptions/emg_biostamp_diag_rx.pdf', 'device'))
...
c.execute("""
    INSERT INTO Prescription (appointment_id, patient, doctor, file_path, created_at, type)
    VALUES (?, ?, ?, ?, datetime('now'), ?)
""", (7, 8, 1, 'Reports/Prescriptions/emg_biostamp_rx.pdf', 'device'))
...
c.execute("""
    ...
    VALUES (?, ?, ?)
""", (8, 'Reports/SensorsReports/complete_report.pdf', '2025-04-29 12:30'))

# Third visit 
c.execute("""
    INSERT INTO SensorsReport (patient, file_path, created_at)
    VALUES (?, ?, ?)
""", (8, 'Reports/SensorsReports/movement_report.pdf', '2025-05-29 12:30'))

# === 4. Add Visit Report ===
c.execute("""
    INSERT INTO VisitReport (appointment_id, file_path, created_at, doctor, patient)
    VALUES (?, ?, datetime('now'), ?, ?)
""", (6, 'Reports/VisitReports/visit_2024_04_15.pdf', 1, 8)) ## Here first visit
c.execute("""
    INSERT INTO VisitReport (appointment_id, file_path, created_at, doctor, patient)
    VALUES (?, ?, datetime('now'), ?, ?)
""", (7, 'Reports/VisitReports/visit_2024_04_30.pdf', 1, 8)) ## Here second one

# === Sensor Performance === 
c.execute("""
    INSERT INTO SensorsPerformanceReport (patient, file_path, created_at, code_device)
    VALUES (?, ?, ?, ?)
""", (8, 'Reports/PerformanceReport/complete_report.pdf', '2025-05-29 12:30', 1))
